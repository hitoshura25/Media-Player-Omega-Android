...
class MyLibraryRepository(
    ...
    override suspend fun getShowsSubscribedAndLastUpdatedBefore(comparisonTime: Long): List<ShowModel>? =
        showPersistenceDataSource.getSubscribedAndLastUpdatedBefore(comparisonTime)
