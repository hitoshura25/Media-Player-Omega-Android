...
abstract class BaseDrawerCollapsingToolbarActivity<COMPONENT : Any, LOCATION : NavigationLocation<*>> :
    BaseDrawerActivity<COMPONENT, LOCATION>(), AppBarLayout.OnOffsetChangedListener {
